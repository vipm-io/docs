...
- **`metadata.tools`** — records the toolchain behind the SBOM: VIPM CLI always, plus VIPM Desktop, LabVIEW, and NI Package Manager when they took part in producing its contents
